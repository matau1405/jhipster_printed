...
export class FactureService {
  ...
  protected convertDateFromClient(facture: IFacture): IFacture {
    const copy: IFacture = Object.assign({}, facture, {
      ...
      paymentDate: facture.paymentDate != null && facture.paymentDate.isValid() ? facture.paymentDate.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((facture: IFacture) => {
        ...
        facture.paymentDate = facture.paymentDate != null ? moment(facture.paymentDate) : null;
      });
    }
    return res;
  }
